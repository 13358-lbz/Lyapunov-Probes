for perturb_times in 0; do
    for perturb_prob in 0.10; do
        ...
        #             --save-file="models/$model/lama3_triviaqa_hlayer_$layer.pt"
        ...
        #             --hidden-path="models/$model/lama3_triviaqa_hlayer_$layer.pt" \
        #             --out-name="models/lama_hidden_scorer/$model/lama3_triviaqa_hscorer_$layer.pt"
        #     ) &
        # done
        ...
        for i in "${!models[@]}"; do
            ...
            (
                CUDA_VISIBLE_DEVICES=$gpu python src/self_knowledge/main.py \
                    ...
                    --hidden-scorer-path="models/lama_hidden_scorer/$model/lama3_triviaqa_hscorer_24.pt" \
                    --save-path="results_pik2_triviaqa/$model/" \
                    --batch-size=32 \
        ...
        python src/self_knowledge/graphing/draw_graphs.py \
            --results-path="results_pik2_triviaqa/" \
